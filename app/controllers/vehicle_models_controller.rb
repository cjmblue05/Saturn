class VehicleModelsController < ApplicationController
  ...
  def index
    @vehicle_models = VehicleModel.order(vehicle_brand_id: :asc, name: :asc).page(params[:page])
  end
  ...
  private
    ...
    def vehicle_model_params
      params.require(:vehicle_model).permit(:name, :vehicle_brand_id, :fuel, :transmission)
    end
end
