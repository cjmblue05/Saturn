...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { part_id: @price.part_id, price: @price.price, supplier_id: @price.supplier_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { part_id: @price.part_id, price: @price.price, supplier_id: @price.supplier_id } }
