...
class VehiclePartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_part" do
    assert_difference('VehiclePart.count') do
      post vehicle_parts_url, params: { vehicle_part: { part_id: @vehicle_part.part_id, vehicle_id: @vehicle_part.vehicle_id } }
    end
  ...
  test "should update vehicle_part" do
    patch vehicle_part_url(@vehicle_part), params: { vehicle_part: { part_id: @vehicle_part.part_id, vehicle_id: @vehicle_part.vehicle_id } }
