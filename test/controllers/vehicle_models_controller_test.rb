...
class VehicleModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehicle_model" do
    assert_difference('VehicleModel.count') do
      post vehicle_models_url, params: { vehicle_model: { fuel: @vehicle_model.fuel, name: @vehicle_model.name, transmission: @vehicle_model.transmission, vehicle_brand_id: @vehicle_model.vehicle_brand_id } }
    end
  ...
  test "should update vehicle_model" do
    patch vehicle_model_url(@vehicle_model), params: { vehicle_model: { fuel: @vehicle_model.fuel, name: @vehicle_model.name, transmission: @vehicle_model.transmission, vehicle_brand_id: @vehicle_model.vehicle_brand_id } }
